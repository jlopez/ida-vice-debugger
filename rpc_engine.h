...
protected:
  ...
  int process_long(bytevec_t &pkt);
...
public:
  ...
  mon_response_t *recv_response(void);
  rpc_packet_t *recv_request(void) { return nullptr; }
  rpc_packet_t *process_request(bytevec_t &pkt, int preq_flags=0);
